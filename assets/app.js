...
Impact / downtime:`;
  ...
  function computeTicketComplete(s) {
    return computeResolved(ensureStateShape("x", s)); // safe normalization
  }
  ...
  /* ----------------------------- PDF (Print-based like old standalone) ----------------------------- */
  ...
  function buildPrintableHtml() {
    ...
    const notes = tickets
      .map((t) => {
        ...
        if (!text) return "";
        const resolved = computeTicketComplete(s);
        return `
    ...
    const css = `
      ...
      .r-wrap { max-width: 980px; margin: 0 auto; }
      .r-header { border: 1px solid #e2e8f0; border-radius: 14px; padding: 16px 18px; }
      .r-top { display:flex; justify-content:space-between; align-items:flex-start; gap: 16px; }
      .r-title { font-weight: 900; font-size: 18px; letter-spacing: .2px; }
      .r-sub { font-size: 12px; color:#334155; font-weight: 700; margin-top: 2px; }
      .r-meta { display:grid; grid-template-columns: repeat(4, minmax(0, 1fr)); gap: 10px; margin-top: 12px; font-size: 12px; color:#0f172a; }
      .r-meta b { font-weight: 800; }
      .section { margin-top: 14px; }
      h2 { font-size: 14px; margin: 0 0 8px 0; }
      .note { font-size: 12px; color:#334155; line-height: 1.45; white-space: pre-wrap; }
      table { width:100%; border-collapse: collapse; }
      thead th { background:#f1f5f9; color:#0f172a; font-size: 11px; text-align:left; padding: 8px; border:1px solid #e2e8f0; }
      tbody td { font-size: 11px; padding: 8px; border:1px solid #e2e8f0; vertical-align: top; }
      tbody tr:nth-child(even) td { background:#fbfdff; }
      .pill { display:inline-block; padding: 3px 8px; border-radius: 999px; font-size: 11px; font-weight: 800; border:1px solid #e2e8f0; }
      ...
      .r-note-item { border:1px solid #e2e8f0; border-radius: 12px; padding: 12px; margin-bottom: 10px; }
      .r-note-head { display:flex; gap: 10px; align-items:center; flex-wrap: wrap; }
      .note-strong { font-weight: 900; color:#0f172a; }
      .note-muted { color:#475569; font-weight: 800; }
      .r-note-body { margin-top: 8px; font-size: 12px; color:#0f172a; white-space: pre-wrap; line-height: 1.45; }
      .print-hint { margin-top: 10px; font-size: 11px; color:#64748b; }
        ...
        <div class="r-wrap">
          <div class="r-header">
            <div class="r-top">
              ...
              <div style="text-align:right; font-size:12px; color:#334155; font-weight:700;">
            ...
            <table>
              <thead>
                <tr>
                  ...
                  <th style="width:60px; text-align:center;">Wrong</th>
                </tr>
              </thead>
              <tbody>
